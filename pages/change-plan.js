...
const ChnagePlan = (props) => {
  ...
  const [planToken, setPlanToken] = useState(
    props.current_plan?.price?.paypal_plan_id
  );
  ...
  const initialState = {
    instruments: props.current_plan?.instruments_array,
    plan: props.current_plan?.price?.plan_id,
    subscription: props.current_plan?.price?.duration_types?.id,
    trading: parseInt(props.current_plan?.price?.trading_type_id),
    payment_method: props.current_plan?.user_prices.payment_method,
  };
                    ...
                    {activeStep === 0 && (
                      <Fragment>
                                    ...
                                    {item.instruments?.length > 0 ? (
                                      <Accordion
                                        ...
                                        classes={{
                                          ...
                                          expanded: "marketAccordionExpanded",
                                        }}
                                      >
                                        <AccordionSummary
                                          ...
                                          id={item.slug}
                                        >
                                          <span translate="no" className="info">
                                            <span className="image">
                                              <img
                                                src={
                                                  (item.slug == "bonds" &&
                        ...
                        <Grid item xs={12}>
                          ...
                          >
                            {getData?.duration_types_through?.map((item) => (
                              <FormControlLabel
                                key={item.id}
                                value={item.id}
                                control={<Radio />}
                          ...
                          {errors.subscription && touched.subscription && (
                            <p className="errorMsg">{errors.subscription}</p>
                          )}
                          ...
                          >
                            ...
                            <span className="payment-method-btn">
                              ...
                              <FormLabel htmlFor="card">
                                ...
                                <span translate="no">Debit/Credit Card</span>
                              </FormLabel>
                            </span>
                          </RadioGroup>
                          {errors.payment_method && touched.payment_method && (
                            <p className="errorMsg">{errors.payment_method}</p>
                          )}
                        </Grid>
                      </Fragment>
                    )}
                        ...
                        <div className="payment-wrap">
                          ...
                          <div className="payment-managment">
                            <div className="payment-managment-left">
                              ...
                              <p>
                                Will be charged today. You can cancel anytime.
                              </p>
                            </div>
                              ...
                              <li>
                                ...
                                <span className="value">
                                  {getData?.trading_types_through
                                    ?.filter((ind) => ind.id == values.trading)
                                    .map((item) => (
                                      <Fragment key={item.id}>
                                        <span translate="no">{item.name}</span>
                                      </Fragment>
                                  ...
                                  <span>
                                    ...
                                    {getData?.duration_types_through
                                      ?.filter(
                                        (ind) => ind.id == values.subscription
                                      )
                                      .map((item) => (
                                        <Fragment key={item.id}>
                                          <span translate="no">
...
ChnagePlan.getInitialProps = async (ctx) => {
